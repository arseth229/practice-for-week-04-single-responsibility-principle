...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  return totRev(totalCost, pieQuantity, profitMargin);

}

function combMessage (recipe, pieType) {
...
function totRev(totalCost, pieQuantity, profitMargin) {
